...
def process_file(counter):
    ...
    plt.pcolormesh(X, Z, sal_avg, shading='auto', cmap='jet',vmin=0,vmax=1.0)
...
def main():
    ...
    images[0].save( titlegif+'.gif' , save_all = True , append_images = images[1:] , duration = 150 , loop = 0)
