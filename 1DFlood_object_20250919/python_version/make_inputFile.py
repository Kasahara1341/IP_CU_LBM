...
print(zb,zb2)
np.savetxt("input/width.csv",width,delimiter=",")
np.savetxt("input/width2.csv",width2,delimiter=",")
np.savetxt("input/position.csv",x,delimiter=",")
np.savetxt("input/position2.csv",x2,delimiter=",")
